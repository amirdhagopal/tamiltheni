import"./pwa-DOeEgxuH.js";import{L as P,T as g,c as B,U as D}from"./config-U83h9fBs.js";import{t as S}from"./theni_words-xXaqkVpm.js";let i=0,A=3,r="all",a=[],m=[],b=[],s=[],y=!1;function q(){const e=document.getElementById("slides-wrapper");e&&(e.innerHTML="",S.forEach((t,n)=>{const l=document.createElement("div");l.className=n===0?"slide active":"slide",l.id=`slide-${n}`;const c=t.sentence_en||t.word_en,o=t.sentence_ta||t.word_ta;l.innerHTML=`
